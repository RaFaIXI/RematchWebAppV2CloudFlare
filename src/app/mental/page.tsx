...
const translations = {
  en: {
    pageTitle: "Competitive Mentality",
    pageDescription: "Discover various mental tips to improve your mentality and teamplay.",
    filterTitle: "Filters",
  ...
  fr: {
    pageTitle: "Mentalité Compétitive",
    pageDescription: "Découvrez différentes astuces et aide pour le mental et améliore ton jeu collectif.",
    filterTitle: "Filtres",
