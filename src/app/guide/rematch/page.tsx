...
export default function Home2() {
  ...
  const translations = {
    en: {
      heading: "Rematch Guide",
      description: "With this rematch guide Learn essential techniques to improve your game with our detailed video tutorials.",
      startButton: "Start",
      aboutTitle: "About",
      aboutDescription:
        "Our platform rematch guide is designed to help players of all levels improve their technical skills. Whether you're a beginner or an experienced player, our tutorials will help you refine your game.",
    ...
    fr: {
      heading: "Guide Rematch",
      description:
        "Guide Rematch : Apprenez les techniques essentielles pour améliorer votre jeu avec nos tutoriels vidéo détaillés.",
      startButton: "Commencer",
      aboutTitle: "À propos",
      aboutDescription:
        "Notre plateforme Guide Rematch est conçue pour aider les joueurs de tous niveaux à améliorer leurs compétences techniques. Que vous soyez débutant ou joueur expérimenté, nos tutoriels vous aideront à perfectionner votre jeu.",
